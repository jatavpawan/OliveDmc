...
@Component({
  selector: 'app-blog-priority',
  templateUrl: './blog-priority.component.html',
  styleUrls: ['./blog-priority.component.css']
})
export class BlogPriorityComponent implements OnInit {
