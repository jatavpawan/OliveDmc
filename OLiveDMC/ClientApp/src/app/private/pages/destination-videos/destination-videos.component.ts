...
@Component({
  selector: 'app-destination-videos',
  templateUrl: './destination-videos.component.html',
  styleUrls: ['./destination-videos.component.css']
})
export class DestinationVideosComponent implements OnInit {
